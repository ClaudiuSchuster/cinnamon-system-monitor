#!/usr/bin/env python3
"""Render or verify every configured Adaptive System Monitor preview."""
...
def main() -> int:
    ...
    stale: list[Path] = []
    with tempfile.TemporaryDirectory(prefix="system-monitor-social-preview-check-") as temporary:
